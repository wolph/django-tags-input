...
The example doubles as the test project, so every model that the test suite
needs is mapped in ``TAGS_INPUT_MAPPINGS`` below. Some mappings point at
models that raise validation errors on purpose.
